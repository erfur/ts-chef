...
[ts-chef API Documentation](../../modules.md) / [operations](../README.md) / Zip

# Class: Zip

Defined in: [operations/Zip.ts:18](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/Zip.ts#L18)
...
https://wikipedia.org/wiki/ZIP_(file_format)
...
Defined in: [operations/Zip.ts:19](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/Zip.ts#L19)
...
Defined in: [operations/Zip.ts:47](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/Zip.ts#L47)
...
Operation arguments: [Filename, Comment, Compression level, Password]

#### Returns

`Promise`\<`ArrayBuffer`\>

The zipped data as an ArrayBuffer.

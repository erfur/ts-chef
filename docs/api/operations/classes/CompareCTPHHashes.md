...
[ts-chef API Documentation](../../modules.md) / [operations](../README.md) / CompareCTPHHashes

# Class: CompareCTPHHashes

Defined in: [operations/CompareCTPHHashes.ts:20](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L20)
...
> **new CompareCTPHHashes**(): `CompareCTPHHashes`
...
Defined in: [operations/CompareCTPHHashes.ts:28](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L28)
...
> **description**: `string` = `"Compares two Context Triggered Piecewise Hashing (CTPH) fuzzy hashes to determine the similarity between them on a scale of 0 to 100."`

Defined in: [operations/CompareCTPHHashes.ts:23](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L23)
...
> **infoURL**: `string` = `"https://forensics.wiki/context_triggered_piecewise_hashing/"`

Defined in: [operations/CompareCTPHHashes.ts:25](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L25)
...
Defined in: [operations/CompareCTPHHashes.ts:26](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L26)
...
Defined in: [operations/CompareCTPHHashes.ts:22](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L22)
...
> **name**: `string` = `"Compare CTPH hashes"`

Defined in: [operations/CompareCTPHHashes.ts:21](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L21)
...
Defined in: [operations/CompareCTPHHashes.ts:27](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L27)
...
Defined in: [operations/CompareCTPHHashes.ts:36](https://github.com/MichaelWeissDEV/ts-chef/blob/3a666cf265e3ec13756556c8404eca75c1140fed/src/chef/operations/CompareCTPHHashes.ts#L36)

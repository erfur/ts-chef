...
describe("AvroToJSON", () => {
  ...
  const VALID_AVRO_HEX =
    "4f626a0104166176726f2e736368656d611022737472696e6722146176726f2e636f646563086e756c6c00e2794a730edd2c888641c88e8f1df323020c0a68656c6c6fe2794a730edd2c888641c88e8f1df323";
  ...
  test("Empty input throws error", async () => {
    ...
    await expect(op.run(input, [true])).rejects.toThrow(

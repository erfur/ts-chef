...
describe("CTPH", () => {
  ...
  test("Similar inputs produce similar hashes (fuzzy hashing property)", () => {
    const input1 =
      "This is a long enough string to test fuzzy hashing properties. It should be relatively stable.";
    const input2 =
      "This is a long enough string to test fuzzy hashing property. It should be relatively stable.";
    const result1 = op.run(input1, []);
    const result2 = op.run(input2, []);

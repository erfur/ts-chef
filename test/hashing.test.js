"use strict";
const { strToAB } = require("./helpers");

const { SHA1 } = require("../dist/chef/operations/SHA1");
const { SHA2 } = require("../dist/chef/operations/SHA2");
const { SHA3 } = require("../dist/chef/operations/SHA3");
...
describe("SHA2 size variants", () => {
    ...
    test.each(sizes)("SHA2-%s produces %d-char hex", (size, length) => {
        const result = new SHA2().run(strToAB("hello"), [size]);

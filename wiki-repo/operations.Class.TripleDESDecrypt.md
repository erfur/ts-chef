...
# Class: TripleDESDecrypt

Defined in: [operations/TripleDESDecrypt.ts:20](https://github.com/MichaelWeissDEV/ts-chef/blob/bdbca45ef0e6eb64c409f2b4715425aa432739b3/src/chef/operations/TripleDESDecrypt.ts#L20)
...
https://wikipedia.org/wiki/Triple_DES
...
> **new TripleDESDecrypt**(): `TripleDESDecrypt`

Defined in: [operations/TripleDESDecrypt.ts:21](https://github.com/MichaelWeissDEV/ts-chef/blob/bdbca45ef0e6eb64c409f2b4715425aa432739b3/src/chef/operations/TripleDESDecrypt.ts#L21)
...
Defined in: [operations/TripleDESDecrypt.ts:46](https://github.com/MichaelWeissDEV/ts-chef/blob/bdbca45ef0e6eb64c409f2b4715425aa432739b3/src/chef/operations/TripleDESDecrypt.ts#L46)
...
The data to decrypt (string or ArrayBuffer).

##### args

`unknown`[]

[Key, IV, Mode, InputType, OutputType]

#### Returns

`ArrayBuffer`

The decrypted data as an ArrayBuffer.

#### Throws

If decryption fails or arguments are invalid.

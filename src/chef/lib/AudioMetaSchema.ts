export interface AudioReport {
    ...
    tags: {
        common: {
            title: null | string; artist: null | string; album: null | string;
            date: null | string; track: null | string; genre: null | string;
            comment: null | string; composer: null | string;
            copyright: null | string; language: null | string;
        };
...
export function makeEmptyReport(filename: string, byteLength: number, container: ContainerInfo): AudioReport {
    return {

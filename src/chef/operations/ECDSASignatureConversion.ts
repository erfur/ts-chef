 ...
 */
export class ECDSASignatureConversion extends Operation {
  /**
  ...
  run(input: any, args: any[]): any {
    ...
    switch (inputFormat) {
      ...
      case "JSON Web Signature":
        if (!inputBase64)
          inputBase64 = fromBase64(input, "A-Za-z0-9-_", "byteArray");
        signatureASN1Hex = r.KJUR.crypto.ECDSA.concatSigToASN1Sig(
          toHexFast(inputBase64 as number[]),
        );
        break;
      case "Raw JSON": {
        ...
        signatureASN1Hex = r.KJUR.crypto.ECDSA.hexRSSigToASN1Sig(
          inputJson.r,
          inputJson.s,
        );
        break;

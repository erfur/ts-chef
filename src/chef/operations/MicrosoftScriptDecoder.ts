...
const D_COMBINATION: number[] = [
  0, 1, 2, 0, 1, 2, 1, 2, 2, 1, 2, 1, 0, 2, 1, 2, 0, 2, 1, 2, 0, 0, 1, 2, 2, 1,
  0, 2, 1, 2, 2, 1, 0, 0, 2, 1, 2, 1, 2, 0, 2, 0, 0, 1, 2, 0, 2, 1, 0, 2, 1, 2,
...
export class MicrosoftScriptDecoder extends Operation {
  constructor() {
    ...
    this.module = "Default";
    this.description = "Decodes Microsoft Encoded Script files (.vbe, .jse).";

...
export class TranslateDateTimeFormat extends Operation {
    constructor() {
        ...
        this.args = [
            { name: "Built-in input formats", type: "option", value: ["Input format"].concat(DATETIME_FORMATS) },
            { name: "Input format string", type: "string", value: "DD/MM/YYYY HH:mm:ss" },
            { name: "Input timezone", type: "string", value: "UTC" },
            { name: "Built-in output formats", type: "option", value: ["Output format"].concat(DATETIME_FORMATS) },
            { name: "Output format string", type: "string", value: "DD/MM/YYYY HH:mm:ss" },

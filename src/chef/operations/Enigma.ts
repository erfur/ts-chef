...
class Rotor {
    ...
    constructor(wiring: string, steps: string, ringSetting: string, initialPosition: string) {
...
export class Enigma extends Operation {
    ...
    run(input: string, args: unknown[]): string {
        ...
        for (let i = 0; i < 4; i++) {
            ...
            rotors.push(new Rotor(rotorWiring, rotorSteps, ringSetting, initialPosition));
        }

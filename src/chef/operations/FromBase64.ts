...
export class FromBase64 extends Operation {
    ...
    run(input: string, args: unknown[]): number[] {
        const [alphabet, removeNonAlphChars, strictMode] = args as [string, boolean, boolean];
        return fromBase64(input, alphabet, "byteArray", removeNonAlphChars, strictMode) as number[];
    }

...
export class CRCChecksum extends Operation {
    ...
    run(input: ArrayBuffer, args: any[]): string {
        ...
        switch (algorithm) {
            ...
            case "CRC-12/UMTS":
                return this.crc(12n, inputBytes, 0x80fn, 0x000n, false, true, 0x000n);
            case "CRC-13/BBC":
                return this.crc(13n, inputBytes, 0x1cf5n, 0x0000n, false, false, 0x0000n);
            case "CRC-14/DARC":
                return this.crc(14n, inputBytes, 0x0805n, 0x0000n, true, true, 0x0000n);
            case "CRC-14/GSM":
                return this.crc(14n, inputBytes, 0x202dn, 0x0000n, false, false, 0x3fffn);
            case "CRC-15/CAN":
                return this.crc(15n, inputBytes, 0x4599n, 0x0000n, false, false, 0x0000n);
            case "CRC-15/MPT1327":
                return this.crc(15n, inputBytes, 0x6815n, 0x0000n, false, false, 0x0001n);
            case "CRC-16":
            ...
            case "CRC-16/ACORN":
                return this.crc(16n, inputBytes, 0x1021n, 0x0000n, false, false, 0x0000n);
            case "CRC-16/ARC":
                return this.crc(16n, inputBytes, 0x8005n, 0x0000n, true, true, 0x0000n);
            case "CRC-16/AUG-CCITT":
                return this.crc(16n, inputBytes, 0x1021n, 0x1d0fn, false, false, 0x0000n);
            case "CRC-16/AUTOSAR":
                return this.crc(16n, inputBytes, 0x1021n, 0xffffn, false, false, 0x0000n);
            case "CRC-16/B":
            ...
            case "CRC-16/BUYPASS":
                return this.crc(16n, inputBytes, 0x8005n, 0x0000n, false, false, 0x0000n);
            case "CRC-16/CCITT":
                return this.crc(16n, inputBytes, 0x1021n, 0x0000n, true, true, 0x0000n);
            ...
            case "CRC-16/CDMA2000":
                return this.crc(16n, inputBytes, 0xc867n, 0xffffn, false, false, 0x0000n);
            case "CRC-16/CMS":
                return this.crc(16n, inputBytes, 0x8005n, 0xffffn, false, false, 0x0000n);
            case "CRC-16/DARC":
                return this.crc(16n, inputBytes, 0x1021n, 0xffffn, false, false, 0xffffn);
            case "CRC-16/DDS-110":
                return this.crc(16n, inputBytes, 0x8005n, 0x800dn, false, false, 0x0000n);
            case "CRC-16/DECT-R":
                return this.crc(16n, inputBytes, 0x0589n, 0x0000n, false, false, 0x0001n);
            case "CRC-16/DECT-X":
                return this.crc(16n, inputBytes, 0x0589n, 0x0000n, false, false, 0x0000n);
            case "CRC-16/DNP":
                return this.crc(16n, inputBytes, 0x3d65n, 0x0000n, true, true, 0xffffn);
            case "CRC-16/EN-13757":
                return this.crc(16n, inputBytes, 0x3d65n, 0x0000n, false, false, 0xffffn);
            case "CRC-16/EPC":
                return this.crc(16n, inputBytes, 0x1021n, 0xffffn, false, false, 0xffffn);
            ...
            case "CRC-16/GENIBUS":
                return this.crc(16n, inputBytes, 0x1021n, 0xffffn, false, false, 0xffffn);
            case "CRC-16/GSM":
                return this.crc(16n, inputBytes, 0x1021n, 0x0000n, false, false, 0xffffn);
            case "CRC-16/I-CODE":
                return this.crc(16n, inputBytes, 0x1021n, 0xffffn, false, false, 0xffffn);
            case "CRC-16/IBM":
                return this.crc(16n, inputBytes, 0x8005n, 0x0000n, true, true, 0x0000n);
            ...
            case "CRC-16/IEC-61158-2":
                return this.crc(16n, inputBytes, 0x1dcfn, 0xffffn, false, false, 0xffffn);
            ...
            case "CRC-16/LHA":
                return this.crc(16n, inputBytes, 0x8005n, 0x0000n, true, true, 0x0000n);
            case "CRC-16/LJ1200":
                return this.crc(16n, inputBytes, 0x6f63n, 0x0000n, false, false, 0x0000n);
            case "CRC-16/LTE":
                return this.crc(16n, inputBytes, 0x1021n, 0x0000n, false, false, 0x0000n);
            case "CRC-16/M17":
                return this.crc(16n, inputBytes, 0x5935n, 0xffffn, false, false, 0x0000n);
            case "CRC-16/MAXIM":
            ...
            case "CRC-16/OPENSAFETY-A":
                return this.crc(16n, inputBytes, 0x5935n, 0x0000n, false, false, 0x0000n);
            case "CRC-16/OPENSAFETY-B":
                return this.crc(16n, inputBytes, 0x755bn, 0x0000n, false, false, 0x0000n);
            ...
            case "CRC-16/SPI-FUJITSU":
                return this.crc(16n, inputBytes, 0x1021n, 0x1d0fn, false, false, 0x0000n);
            case "CRC-16/T10-DIF":
                return this.crc(16n, inputBytes, 0x8bb7n, 0x0000n, false, false, 0x0000n);
            case "CRC-16/TELEDISK":
                return this.crc(16n, inputBytes, 0xa097n, 0x0000n, false, false, 0x0000n);
            ...
            case "CRC-16/ZMODEM":
                return this.crc(16n, inputBytes, 0x1021n, 0x0000n, false, false, 0x0000n);
            case "CRC-17/CAN-FD":
                return this.crc(17n, inputBytes, 0x1685bn, 0x00000n, false, false, 0x00000n);
            case "CRC-21/CAN-FD":
                return this.crc(21n, inputBytes, 0x102899n, 0x000000n, false, false, 0x000000n);
            case "CRC-24/BLE":
                return this.crc(24n, inputBytes, 0x00065bn, 0x555555n, true, true, 0x000000n);
            case "CRC-24/FLEXRAY-A":
                return this.crc(24n, inputBytes, 0x5d6dcbn, 0xfedcban, false, false, 0x000000n);
            case "CRC-24/FLEXRAY-B":
                return this.crc(24n, inputBytes, 0x5d6dcbn, 0xabcdefn, false, false, 0x000000n);
            case "CRC-24/INTERLAKEN":
                return this.crc(24n, inputBytes, 0x328b63n, 0xffffffn, false, false, 0xffffffn);
            case "CRC-24/LTE-A":
                return this.crc(24n, inputBytes, 0x864cfbn, 0x000000n, false, false, 0x000000n);
            case "CRC-24/LTE-B":
                return this.crc(24n, inputBytes, 0x800063n, 0x000000n, false, false, 0x000000n);
            case "CRC-24/OPENPGP":
                return this.crc(24n, inputBytes, 0x864cfbn, 0xb704cen, false, false, 0x000000n);
            case "CRC-24/OS-9":
                return this.crc(24n, inputBytes, 0x800063n, 0xffffffn, false, false, 0xffffffn);
            case "CRC-30/CDMA":
                return this.crc(
                    30n,
                    inputBytes,
            ...
            case "CRC-32":
                return this.crc(32n, inputBytes, 0x04c11db7n, 0xffffffffn, true, true, 0xffffffffn);
            case "CRC-32/AAL5":
                return this.crc(
                    32n,
                    inputBytes,
            ...
            case "CRC-32/AUTOSAR":
                return this.crc(32n, inputBytes, 0xf4acfb13n, 0xffffffffn, true, true, 0xffffffffn);
            case "CRC-32/BASE91-C":
                return this.crc(32n, inputBytes, 0x1edc6f41n, 0xffffffffn, true, true, 0xffffffffn);
            case "CRC-32/BASE91-D":
                return this.crc(32n, inputBytes, 0xa833982bn, 0xffffffffn, true, true, 0xffffffffn);
            case "CRC-32/BZIP2":
                return this.crc(
                    32n,
                    inputBytes,
            ...
            case "CRC-32/CD-ROM-EDC":
                return this.crc(32n, inputBytes, 0x8001801bn, 0x00000000n, true, true, 0x00000000n);
            case "CRC-32/CKSUM":
                return this.crc(
                    32n,
                    inputBytes,
            ...
            case "CRC-32/ISO-HDLC":
                return this.crc(32n, inputBytes, 0x04c11db7n, 0xffffffffn, true, true, 0xffffffffn);
            case "CRC-32/JAMCRC":
                return this.crc(32n, inputBytes, 0x04c11db7n, 0xffffffffn, true, true, 0x00000000n);
            case "CRC-32/MEF":
                return this.crc(32n, inputBytes, 0x741b8cd7n, 0xffffffffn, true, true, 0x00000000n);
            case "CRC-32/MPEG-2":
                return this.crc(
                    32n,
                    inputBytes,
    ...
    private generateTable(width: bigint, poly: bigint, MASK: bigint, TOP_BIT: bigint): bigint[] {
        const table = new Array(256);
        for (let byte = 0n; byte < 256n; byte++) {
            let value = (byte << (width - 8n)) & MASK;
            for (let bit = 0n; bit < 8n; bit++) {
                value =
                    (value & TOP_BIT) === 0n ? (value << 1n) & MASK : ((value << 1n) & MASK) ^ poly;
            }

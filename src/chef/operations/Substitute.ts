...
export class Substitute extends Operation {
    constructor() {
        ...
        this.args = [
            { name: "Plaintext", type: "binaryString", value: "ABCDEFGHIJKLMNOPQRSTUVWXYZ" },
            { name: "Ciphertext", type: "binaryString", value: "XYZABCDEFGHIJKLMNOPQRSTUVW" },
    ...
    run(input: string, args: unknown[]): string {
        const [plaintextArg, ciphertextArg, ignoreCase] = args as [string, string, boolean];

...
export class BLAKE2s extends Operation {
    ...
    run(input: ArrayBuffer, args: unknown[]): string {
        ...
        let key: Uint8Array | null = new Uint8Array(
            Utils.convertToByteArray((args[2] as ToggleStringArg).string || "", (args[2] as ToggleStringArg).option)
        );
        ...
        switch (outFormat) {
            ...
            case "Raw":
                return Utils.arrayBufferToStr(blakejs.blake2s(data, key, sizeBytes).buffer, false);
            default:

...
export class AnalyseUUID extends Operation {
    ...
    run(input: string, args: any[]): string {
        ...
        const uuidInteger = (BigInt(dv.getBigUint64(0)) << 64n) | BigInt(dv.getBigUint64(8));
 ...
 */
const UUID_PARSERS: Record<number, (uuidBytes: Uint8Array, dv: DataView) => any> = Object.freeze({
    1: parsev1v6,
    6: parsev1v6,
    7: parsev7,
});

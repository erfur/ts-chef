...
export class SHA3 extends Operation {
    ...
    run(input: ArrayBuffer, args: unknown[]): string {
        ...
        switch (size) {
            case 224: return JSSHA3.sha3_224(buf);
            case 256: return JSSHA3.sha3_256(buf);
            case 384: return JSSHA3.sha3_384(buf);
            case 512: return JSSHA3.sha3_512(buf);
            default: throw new OperationError("Invalid size");
        }
    }
}

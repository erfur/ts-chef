...
export class FromHTMLEntity extends Operation {
  constructor() {
    super();
...
const ENTITY_TO_BYTE: Record<string, number> = {
  Tab: 9,
  NewLine: 10,
  excl: 33,
  quot: 34,
